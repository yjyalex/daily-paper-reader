...
tags: ["query:mas-gen"]
score: 9.0
evidence: 用于复杂推理任务的多智能体大语言模型路由与协作
...
method: 提出AMRO-S框架，结合小模型意图推理、任务特定信息素专家和质量门控异步更新机制来优化路径选择。
result: 在五个公开基准测试和高并发压力测试中，AMRO-S在质量与成本的权衡上均优于现有基准，并展现出良好的可解释性。
conclusion: AMRO-S为多智能体系统提供了一种高效、可扩展且具备可解释性的路由解决方案，有效提升了资源利用率。
---
